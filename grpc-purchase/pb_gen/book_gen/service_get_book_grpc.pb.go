...
func (c *bookServiceClient) GetBook(ctx context.Context, in *GetBookRequest, opts ...grpc.CallOption) (*GetBookResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/com.bookstore.pb_gen.book_gen.BookService/getBook", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BookService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.bookstore.pb_gen.book_gen.BookService/getBook",
	}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bookstore.pb_gen.book_gen.BookService",
	...
	Metadata: "service_get_book.proto",
}
